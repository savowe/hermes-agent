    ...
    try:
        ...
        try:
            ...
            if pull_result.returncode != 0:
                ...
                # cannot fast-forward, and `reset --hard` would silently
                ...
                if _cur_branch and _cur_branch != branch:
                    ...
                    # Never discard committed work on the update target either.
                    # The fork's divergence guard handles the true force-push
                    # case without replacing local history.
